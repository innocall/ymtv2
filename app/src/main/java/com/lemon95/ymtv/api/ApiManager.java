...
//    private static String AppKey = "ym";
    ...
    public static Observable<GenresMovie> getMoviesByGenres(String genreIds,String vipLevel,String currenPage,String pageSize) {
        return apiManager.getMoviesByGenres(genreIds, currenPage, pageSize);
    }
     ...
     * @return
     */
    public static Observable<SerialDitions> getSerialDetail(String id,String userId) {
        return apiManager.getSerialDetail(id, userId);
    }
     ...
     * @return
     */
    public static Observable<List<String>> getSerialAnalysis2(String episodeId,String index) {
        return apiManager.getSerialAnalysis2(episodeId,index);
    }
     ...
     * @return
     */
    public static Observable<Live> getTVs(String type) {
        return apiManager.getTVs(type);
    }
     ...
     * @return
     */
    public static Observable<SingleSerialEpisode> getSingleSerialEpisode2(String serialId,String index) {
        return  apiManager.getSingleSerialEpisode2(serialId, index);
    }
}
