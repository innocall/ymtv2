...
public interface ApiManagerService {
    ...
    @GET("/Media/App/Detail/Movie")
    Observable<Movie> getDetail(@Query("movieId") String movieId,@Query("userId") String userId,@Query("isPersonal") boolean isPersonal);
    ...
    Observable<GenresMovie> getMoviesByGenres(@Query("genreIds") String genreIds,@Query("currentPage") String currentPage,@Query("pageSize") String pageSize);
     ...
     * @return
     */
    @GET("/Media/App/Detail/Serial")
    Observable<SerialDitions> getSerialDetail(@Query("serialId") String id,@Query("userId") String userId);
     ...
     * @return
     */
    @GET("/Media/Serials/SerialAnalysis2")
    Observable<List<String>> getSerialAnalysis2(@Query("serialId") String serialId,@Query("index") String index);
...
//    })
    ...
    @GET("/Media/TVs")
    Observable<Live> getTVs(@Query("type")String type);

    @GET("/Media/Serials/SingleSerialEpisode2")
    Observable<SingleSerialEpisode> getSingleSerialEpisode2(@Query("serialId")String serialId,@Query("index")String index);
}
