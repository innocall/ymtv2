...
public class MovieDetailsPresenter {
    ...
    public void initSerialData(String id,String userId) {
        iMovieBean.getSerialDetail(id,userId, new MovieDao.OnSerialDitionListener() {
            @Override
            public void onSuccess(SerialDitions serialDitions) {
                SerialDitions.Data data = serialDitions.getSerial();
                if (data != null) {
