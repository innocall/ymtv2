...
public interface IMovieBean {
     ...
     */
    public void getSerialDetail(String id,String userId,MovieDao.OnSerialDitionListener onSerialDitionListener);
     ...
     * @param onMovieAnalysisListener
     */
    public void getSerialAnalysis2(String id,String index,MovieDao.OnSerialAnalysisListener2 onMovieAnalysisListener);
    ...
    public void getSingleSerialEpisode2(String id,String index,MovieDao.OnSerialDitionsListener onSerialDitionsListener);
}
