...
public class MovieDao implements IMovieBean{
        ...
        ApiManager.getCombQueryConditions(type).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<Conditions>() {
                    ...
                    public void call(Conditions conditions) {
                        LogUtils.i(TAG, conditions.toString());
    ...
    @Override
    public void getSerialDetail(String id,String userId, final OnSerialDitionListener onSerialDitionListener) {
        ApiManager.getSerialDetail(id, userId).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<SerialDitions>() {

                    @Override
                    public void call(SerialDitions serialDitions) {
                        LogUtils.i(TAG, serialDitions.toString());
    ...
    @Override
    public void getSerialAnalysis2(String id,String index, final OnSerialAnalysisListener2 onMovieAnalysisListener) {
        ApiManager.getSerialAnalysis2(id, index).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<List<String>>() {

                    @Override
                    public void call(List<String> movieSources) {
                        onMovieAnalysisListener.onSuccess(movieSources);
                    }
                }, new Action1<Throwable>() {
                    @Override
    ...
    @Override
    public void getSingleSerialEpisode2(String id, String index, final OnSerialDitionsListener onSerialDitionsListener) {
        ApiManager.getSingleSerialEpisode2(id, index).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<SingleSerialEpisode>() {

                    @Override
                    public void call(SingleSerialEpisode singleSerialEpisode) {
                        onSerialDitionsListener.onSuccess(singleSerialEpisode);
                    }
                }, new Action1<Throwable>() {
                    @Override
                    public void call(Throwable throwable) {
                        throwable.printStackTrace();
                        onSerialDitionsListener.onFailure(throwable);
                    }
                });
    }
    ...
    public interface OnSerialAnalysisListener2{
        void onSuccess(List<String> movieSources);
        void onFailure(Throwable e);
    }
    ...
    public interface OnSerialDitionsListener{
        void onSuccess(SingleSerialEpisode singleSerialEpisode);
        void onFailure(Throwable e);
    }
