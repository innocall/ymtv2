...
public class HoloDrawable extends WheelDrawable {
    ...
    private void init() {
        ...
        mHoloBgPaint.setColor(mStyle.backgroundColor != -1 ? mStyle.backgroundColor : WheelConstants
                .WHEEL_SKIN_HOLO_BG);
       // mHoloBgPaint.setStyle(Paint.Style.FILL);
       ...
       // mHoloPaint.setColor(Color.parseColor("#3F51B5"));
       // mHoloPaint.setStyle(Paint.Style.FILL);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (mItemH != 0) {
            ...
            /*canvas.drawLine(0, mItemH * (mWheelSize / 2), mWidth, mItemH, mHoloPaint);
