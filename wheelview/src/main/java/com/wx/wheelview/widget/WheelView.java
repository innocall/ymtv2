...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    private OnScrollListener mOnScrollListener = new OnScrollListener() {
        ...
        public void onScrollStateChanged(AbsListView view, int scrollState) {
            if (scrollState == SCROLL_STATE_IDLE) {
                //Log.e("WheelView","滚动位置:" + scrollState);
    ...
    public void toSelect(int poinst,int selection) {
        Log.e("WheelView", "poinst=" + poinst);
        //smoothScrollBy(poinst, WheelConstants.WHEEL_SMOOTH_SCROLL_DURATION);
        setSelectionFromTop(selection, poinst); //设置listView 选中位置
